            ...
            <Layout full>
                        ...
                        {!this.prop.didMount ? null :
                            <IonToolbar className="toolbar-title-default md in-toolbar hydrated bg-top_home_panel" style={styles('--background:transparent;')}>
                                ...
                                <IonButtons slot="start">
                                    ...
                                    <IonMenuButton />
                                    <IonTitle>Account Profile</IonTitle>
                                </IonButtons>
                                <IonLabel slot="end" style={styles('font-weight:bold;font-size:13pt;')}>Edit</IonLabel>
                                <IonToggle slot="end" style={styles('--background-checked:rgba(245, 233, 12, 0.5);--handle-background-checked:linear-gradient(#f6f642, #ff9701);--handle-background: linear-gradient(#f6f642, #ff9701);')}
                                    onIonChange={(e) => this.onToggleEdit(e.detail.checked)}
                ...
                <Layout auto>
                    ...
                    <Layout full>
                                                    ...
                                                    <SuperTab noScroll style={styles('width:100%')}>
                                                        ...
                                                        <div className="page-1" style={styles('padding:1px;')} hidden={input!.NextPage === 'p1' ? false : true}>
                                                                    ...
                                                                    <div className={classNames({ 'input-invalid': !!msg.Gender })} style={styles('position:relative')}>
                                                                        <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px')}>
                                                                            ...
                                                                            <Input ion="popup" node={(handle) => <>
                                                                                ...
                                                                                <IonSelect interface="action-sheet" cancelText="Dismiss" style={styles('height:40px;color:#fefed1;')}
                                                                                    value={input.Gender} {...handle({ onChange: (ev) => this.hState(ev, 'Gender') })} readonly={!input.ToggleEdit}>
                                                                    ...
                                                                    <div className={classNames({ 'input-invalid': !!msg.BloodType })} style={styles('position:relative')}>
                                                                        <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px')}>
                                                                            ...
                                                                            <Input ion="popup" node={(handle) => <>
                                                                                <IonInput hidden></IonInput>
                                                                                <IonSelect interface="action-sheet" cancelText="Dismiss" style={styles('height:40px;color:#fefed1;')}
                                                                                    value={input.BloodType} {...handle({ onChange: (ev) => this.hState(ev, 'BloodType') })} readonly={!input.ToggleEdit}>
                                                                    ...
                                                                    <div className={classNames({ 'input-invalid': !!msg.MaritalStatus })} style={styles('position:relative')}>
                                                                        <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px')}>
                                                                            ...
                                                                            <Input ion="popup" node={(handle) => <>
                                                                                <IonInput hidden></IonInput>
                                                                                <IonSelect interface="action-sheet" cancelText="Dismiss" style={styles('height:40px;color:#fefed1;')}
                                                                                    value={input.MaritalStatus} {...handle({ onChange: (ev) => this.hState(ev, 'MaritalStatus') })} readonly={!input.ToggleEdit}>
                                                                ...
                                                                <div className="col-4 p-0">
                                                                    <div className={classNames({ 'input-invalid': !!msg.Height })} style={styles('position:relative')}>
                                                                        <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px;margin-right:1.25px;')}>
                                                                            <IonLabel position="floating" style={styles('font-weight:bold;margin-top:-7.5px')}>Height <span style={styles('font-size:85%')}>(ft)</span></IonLabel>
                                                                            <Input ion node={(handle) => <>
                                                                                <IonInput className="font-bold br-0"
                                                                                    type="text"
                                                                ...
                                                                <div className="col-4 p-0">
                                                                    <div className={classNames({ 'input-invalid': !!msg.Weight })} style={styles('position:relative')}>
                                                                        <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px;margin-left:1.25px;')}>
                                                                            <IonLabel position="floating" style={styles('font-weight:bold;margin-top:-7.5px')}>Weight <span style={styles('font-size:85%')}>(kg)</span></IonLabel>
                                                                            <Input ion node={(handle) => <>
                                                                                <IonInput className="font-bold br-0"
                                                                                    type="number"
                                                            ...
                                                            <div className={classNames({ 'input-invalid': !!msg.Birthplace })} style={styles('position:relative')}>
                                                                <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px')}>
                                                                    <IonLabel position="floating" style={styles('font-weight:bold;margin-top:-7.5px')}>Place of Birth</IonLabel>
                                                                    <Input ion node={(handle) => <>
                                                            ...
                                                            <div className="row m-0">
                                                                <div className="col-6 p-0">
                                                                    <div className={classNames({ 'input-invalid': !!msg.Country })} style={styles('position:relative')} >
                                                                        <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px;margin-right:1.25px;')}>
                                                                            <IonLabel position="floating" style={styles('font-weight:bold;margin-top:-7.5px')}><span style={styles('color:red')}>*</span>Country</IonLabel>
                                                            ...
                                                            <div style={styles('position:relative')}>
                                                                <IonItem style={styles('--background: primary;margin-top: 2px;--color: #fdb67f;')}>
                                                                    <IonCheckbox style={styles('--background:primary;--border-color: rgba(245, 233, 12, 0.75);--background-checked: #fdb67f;--border-color-checked:rgba(245, 233, 12, 0.75);--checkmark-color: #000;opacity:1;')}
                                                        ...
                                                        <div className="page-2" hidden={input!.NextPage === 'p2' ? false : true}>
                                                            ...
                                                            <div style={styles('position:relative;padding:1px;margin-top:2.5px;')}>
                                                                <div style={styles('border: 1px solid rgba(245, 233, 12, 0.75);border-radius:12px;')}>
                                                                    <IonList lines="none">
                                                                        <IonTitle style={styles('color:#fff;')}>Social Details</IonTitle>
                                                                        <IonItem>
                                                                            <IonCheckbox style={styles('--border-color:rgba(245, 233, 12, 0.75);--border-color-checked:rgba(245, 233, 12, 0.75);--background-checked:#fdb67f;--checkmark-color:#000;opacity:1;')}
                                                        ...
                                                        <div style={styles('position:relative;')}>
                                                            <IonRow>
                                                                <IonCol>
                                                                    <IonItem style={styles('--background:primary;--highlight-background:unset;--min-height:40px;margin-top:2.5px;padding:5px;')}>
                        ...
                        <div style={styles('background-color:#1d2c65;height:45px')} hidden={!input.ToggleEdit}>
                            <IonButton style={styles('width:99%;height:99%;--background:linear-gradient(#33ccff, #0066ff);padding-bottom:5px;')}
