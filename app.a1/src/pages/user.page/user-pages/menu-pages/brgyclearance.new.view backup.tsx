                                ...
                                <form className={classNames('needs-validation', { 'form-invalid': !input.IsValid })} noValidate onSubmit={(ev) => ev.preventDefault()}>
                                    ...
                                    <div className={classNames({ 'input-invalid': !!msg.TypeofClearance })} style={styles('position:relative')}
                                        ...
                                        <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px')}>
                                            <IonLabel position="floating" style={styles('font-weight:bold;margin-top:-7.5px')}><span style={styles('color:red')}>*</span>Type of Clearance</IonLabel>
                                    ...
                                    <div className={classNames({ 'input-invalid': !!msg.PurposeID })} style={styles('position:relative')}
