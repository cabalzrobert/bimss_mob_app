...
import { arrowBackOutline, arrowBackSharp, call, cameraOutline, cardOutline, personOutline, saveOutline } from 'ionicons/icons';
                        ...
                        <Layout auto>
                            ...
                            <div className="row m-0 bootstrap-form old">
                                <div className='col-12 p-0 form-container' style={styles('width: 100%;background-color: transparent;')}>
                                    <form className={classNames('needs-validation', { 'form-invalid': !input.IsValid })} noValidate onSubmit={(ev) => ev.preventDefault()} style={styles('padding:2%;')}>
                                        <div className={classNames({ 'input-invalid': !!msg.GovernmentID })} style={styles('position:relative;')}
                                            onClick={this.hGovernmentID}>
                                                <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}><span style={styles('color:red')}>*</span>Select Government ID</IonLabel>
                                        ...
                                        <div className={classNames({ 'input-invalid': !!msg.GovValIDNo })} style={styles('position:relative;margin-top:7.5px;')}>
                                                <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}><span style={styles('color:red')}>*</span>ID Number</IonLabel>
                                            <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px')}>
                                        ...
                                        <div style={styles('color:#000;font-weight:bold;padding:15px 2.5px')} >
                                            <div className="row m-0">
                                                <div className="col-4 p-0" style={styles('margin-top:auto;margin-bottom:auto;')}>
                                                    <IonLabel style={styles('margin-left:12px;')}>Attachment:</IonLabel>
                                                </div>
                                                <div className="col-8 p-0">
                                                    <IonButton onClick={this.hPickImage}>
                                            ...
                                            <div className="horizontal">
                                                <div style={styles('margin:5px 0px;position:relative;')}>
                                                    ...
                                                    <div className="img.img-fit-stl" onClick={this.hViewImg} style={styles('border-style:dashed;height:300px;border-color:rgba(204, 207, 231,1)')}>
                                        ...
                                        <div className="horizontal" style={styles('margin-top:5px;height:40px')}>
