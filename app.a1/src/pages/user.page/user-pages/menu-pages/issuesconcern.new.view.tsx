...
export default class IssuesConcernUpdate extends React.Component {
        ...
        rest.post('siteleader/member/edit', this.input).subscribe(async (res: any) => {
            if (res.Status == 'ok') {
                ...
                return Alert.showSuccessMessage(res.Message,
                    () => this.pager.back({ item, component: IssuesConcernUpdate, IsUpdate: !!this.prop.IsUpdate, }));
            }
                    ...
                    <IonHeader>
                        <IonToolbar className="toolbar-title-default md in-toolbar hydrated bg-top_home_panel" style={styles('--background:transparent;')}>
                            <IonButtons slot="start">
                                <IonMenuButton />
                                <IonTitle>Issues and Concern</IonTitle>
                            </IonButtons>
                        </IonToolbar>
                    </IonHeader>
