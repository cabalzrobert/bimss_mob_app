...
import { base64HTML, numberWithComma } from '../../../../tools/global';
...
export default class HelpCenterView extends React.Component {
...
export class ViewHolder extends React.Component {
    ...
    private performRequest(filter:any, callback:Function=mtCb){
        ...
        this.subs.s1 = rest.post('post/helpcenter', filter).subscribe(async(res:any)=>{
...
<Layout full>
    <Layout>
        <div className="row m-0 toolbar-panel">
            ...
            <div className="col-7 p-0 toolbar-title vertical"><div><TextFit text="Help Center"/></div></div>
        </div>
    </Layout>
    <Layout auto>
        ...
        <IonContent scrollY>
            ...
            <IonList lines='none'>
                ...
                {list?.map((item:any,idx:any)=>
                    <div className={classNames('list-item',{'bg arrow':!item.NextFilter})}>
...
<div className="row m-0 details ion-activatable" onClick={onClick}> 
    <IonRippleEffect /> 
    <div className="col-2 horizontal">
        <div className="vertical" style={styles('height:50px')}>
            <img src="./assets/img/profile_help_center_icon.png" style={styles('width:40px')} />
        </div>
    </div>
