...
export class ViewHolder extends React.Component {
    ...
    async popUpCustomerActionPopUp(subscriber: any) {
        const modal = await CustomerActionPopUp.modal(subscriber);
        await modal.present();
            ...
            <Layout full>
                <Layout>
                    <div className="row m-0 toolbar-panel">
                        ...
                        <div className="col-7 p-0 toolbar-title vertical"><div><TextFit text="Events" /></div></div>
                    </div>
                </Layout>
                        ...
                        <div style={styles('padding:5px')}>
                            <div className="row m-0">
                                <div className="col-12 p-0">
                                    <div style={styles('font-size:12px;color:#fefed1;')}>Enter any keyword to search and hit search button</div>
                                </div>
                            </div>
                            <div className="row m-0">
                        ...
                        <IonList lines='none'>
                            <div className="list wbg">
                                {list?.map((item: any, idx: any) =>
                                    <div className={classNames('list-item', { 'bg': (!item.NextFilter || item.IsBlocked), 'bg-black': !item.NextFilter, 'border-red': item.IsBlocked })}>
                ...
                <div className="layout-horizontal">
                    ...
                    <div className="auto">
                        <div className="vertical" style={styles('position:relative;color:#fefed1;')}>
                            <div style={styles('font-weight: bold')}>Title: {item.Tittle}</div>
                            <div style={styles('font-size: 12px;margin-top: -2.5px')}>Description: {item.Description}</div>
                            <div style={styles('font-size: 12px;margin-top: -2.5px')}>Date/Time: {item.EventDate}</div>
                            <div style={styles('font-size: 12px;margin-top: -2.5px')}>Location: {item.Location}</div>
                        </div>
                    </div>
                </div>
