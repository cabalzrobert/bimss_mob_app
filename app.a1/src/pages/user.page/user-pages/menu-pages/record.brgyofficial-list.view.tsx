...
export default class BrgyOfficialAppHistory extends React.Component implements OnPagerFocus { //OnSwapFocus, 
...
export class ViewHolder extends React.Component {
    ...
    private performRequest(filter: any, callback: Function = mtCb) {
        ...
        console.log(filter);
        this.subs.s1 = rest.post('official/brgyofficial/history', Object.rcopy(filter, this.filter)).subscribe(async (res: any) => {
                ...
                <Layout>
                    <IonHeader>
                        {!prop.didMount ? null :
                            ...
                            //         <IonMenuButton />
                            //         <IonTitle>Barangay Official</IonTitle>
                            //     </IonButtons>
                            // </IonToolbar>
                        }
                    </IonHeader>
                                    ...
                                    <IonItemSearch lines="none" className="input-error bg-adjust" style={styles('--highlight-background:unset;--min-height:40px')}>
                                        <Input ion="popup" node={(handle) => <>
                                            <IonInput className="font-bold br-0" style={styles('--padding-bottom:0px;--padding-top:0px;color:#fefed1')}
                                                type="text" placeholder="Search Barangay Official" value={filter.Search} {...handle({ onChange: (ev) => this.hFState(ev, 'Search') })} />
                                        </>} />
                        ...
                        <IonList lines='none'>
                            <div className="list wbg">
                                {list?.map((item: any, idx: any) =>
                                    <IonCard style={styles('--background:rgba(0, 6, 69, 0.1);border-radius:12px;')}>
                                        <IonCardContent>
                ...
                <div className="layout-horizontal">
                    ...
                    <div className="auto">
                        ...
                        <div className="vertical" style={styles('position:relative;color:#737373;')}>
                            ...
                            <div style={styles('font-size: 12pt;font-weight: bold;margin: auto;margin-top: 5px;')}>Position: {item.BarangayPosition}</div>
                            <div style={styles('font-size: 12pt;margin: auto;font-weight: bold')}>Name: {item.ElectedOfficial}</div>
                            <div style={styles('font-size: 11pt;margin: auto;margin-top: -2.5px;')}>Committee: {item.Committee}</div>
                            <div style={styles('font-size: 11pt;margin: auto;margin-top: -2.5px;')}>Term Start: {item.TermStart}</div>
                            <div style={styles('font-size: 11pt;margin: auto;margin-top: -2.5px;')}>Term End.: {item.TermEnd}</div>
