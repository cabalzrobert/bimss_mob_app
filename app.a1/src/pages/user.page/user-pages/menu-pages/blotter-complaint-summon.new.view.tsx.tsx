import { IonButton, IonContent, IonIcon, IonInput, IonItem, IonLabel, IonTextarea, IonSelect, IonSelectOption, IonList, IonRefresher, IonRefresherContent, IonRippleEffect, IonSearchbar, IonSpinner, IonDatetime, IonCheckbox, IonTitle, IonHeader } from '@ionic/react';
                            ...
                            <div className='col-12 p-0 form-container' style={styles('width: 100%;background-color: transparent;')}>
                                <form className={classNames('needs-validation', { 'form-invalid': !input.IsValid })} noValidate onSubmit={(ev) => ev.preventDefault()} style={styles('padding:10px;')}>
                                    ...
                                    <div className={classNames({ 'input-invalid': !!msg.ComplainantName })} style={styles('position:relative')}>
                                            <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}><span style={styles('color:red')}>*</span>Complainant</IonLabel>
                                    ...
                                    {/* Respondent Name */}
                                    <div className={classNames({ 'input-invalid': !!msg.Respondent })} style={styles('position:relative;margin-top:7.5px;')}
                                        onClick={this.hResident}>
                                            <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}><span style={styles('color:red')}>*</span>Select Resident for Respondent</IonLabel>
                                        <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px')}>
                                            <Input ion="popup" node={(handle) => <>
                                                <IonLabel hidden position='stacked'></IonLabel>
                                                <IonInput hidden></IonInput>
                                                <IonSelect interface="action-sheet" cancelText="Dismiss" style={styles('height:50px')} multiple={true}
                                    ...
                                    <div className={classNames({ 'input-invalid': !!msg.Witness })} style={styles('position:relative;margin-top:7.5px;')}>
                                            <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}><span style={styles('color:red')}>*</span>Witness (Lastname, Firstname, for multiple witness )</IonLabel>
                                        <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px')}>
                                            <Input ion node={(handle) => <>
                                                <IonInput className="font-bold br-0"
                                                    type="text"
                                    ...
                                    {/* Complaint Type */}
                                    <div className={classNames({ 'input-invalid': !!msg.ComplaintType })} style={styles('position:relative;margin-top:7.5px;')}>
                                            <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}><span style={styles('color:red')}>*</span>Compaint Type</IonLabel>
                                        <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px')}>
                                            <Input ion="popup" node={(handle) => <>
                                                <IonLabel hidden position='stacked'></IonLabel>
                                                <IonInput hidden></IonInput>
                                                <IonSelect interface="action-sheet" cancelText="Dismiss" style={styles('height:50px')}
                                    ...
                                    <div className={classNames({ 'input-invalid': !!msg.IncidentPlace })} style={styles('position:relative;margin-top:7.5px;')}
                                        onClick={this.hSelectSitio}>
                                            <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}><span style={styles('color:red')}>*</span>Select Sitio/ Purok Place of Incedent</IonLabel>
                                        <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px')}>
                                            <Input ion="popup" node={(handle) => <>
                                                <IonLabel hidden position='stacked'></IonLabel>
                                                <IonInput hidden></IonInput>
                                    ...
                                    <div className="row m-0">
                                        <div className="col-6 p-0">
                                            <div className={classNames({ 'input-invalid': !!msg.IncidentDate })} style={styles('position:relative;margin-top:7.5px;')}>
                                                    <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}><span style={styles('color:red')}>*</span>Incident Date</IonLabel>
                                                <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px')}>
                                                    <Input ion node={(handle) => <>
                                                        <IonInput hidden />
                                        ...
                                        <div className="col-6 p-0">
                                            <div className={classNames({ 'input-invalid': !!msg.IncidentTime })} style={styles('position:relative;margin-top:7.5px;')}>
                                                    <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}><span style={styles('color:red')}>*</span>Time</IonLabel>
                                                <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px;margin-right:1.25px;')}>
                                                    <IonInput hidden />
                                                    <IonDatetime pickerFormat="hh:mm A" displayFormat="hh:mm A" style={styles('--padding-bottom:5px;height:50px')}
                                    ...
                                    <div className={classNames({ 'input-invalid': !!msg.Issue })} style={styles('position:relative;margin-top:7.5px;')}>
                                            <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}><span style={styles('color:red')}>*</span>Issue</IonLabel>
                                    ...
                                    <div className={classNames({ 'input-invalid': !!msg.Statement })} style={styles('position:relative;margin-top:10px')}>
                                            <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}>Blotter Details</IonLabel>
                                    ...
                                    <div style={styles('font-weight:bold;padding:10px 2.5px')} >
                                    ...
                                    <div className="horizontal" style={styles('height:40px;')}>
