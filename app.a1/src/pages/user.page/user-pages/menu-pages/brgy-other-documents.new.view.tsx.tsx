                ...
                <Layout auto>
                    ...
                    <IonContent scrollY>
                        <div className="row m-0 bootstrap-form old">
                            <div className='col-12 p-0 form-container' style={styles('width: 100%;background-color: #ffffff;')}>
                                <form className={classNames('needs-validation', { 'form-invalid': !input.IsValid })} noValidate onSubmit={(ev) => ev.preventDefault()} style={styles('padding:10px;')}>
                                    ...
                                    <div className={classNames({ 'input-invalid': !!msg.TemplateTypeID })} style={styles('position:relative')}
                                        onClick={this.hTemplateType}>
                                            <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}><span style={styles('color:red')}>*</span>Select Document Type</IonLabel>
                                    ...
                                    {/* Document Type */}
                                    <div className={classNames({ 'input-invalid': !!msg.TemplateID })} style={styles('position:relative;margin-top:7.5px;')}
                                        onClick={this.hTemplateDoc}>
                                            <IonLabel position="fixed" style={styles('font-weight:bold;margin-top:-7.5px;margin-left:12px;')}><span style={styles('color:red')}>*</span>Select Certificate</IonLabel>
                                        <IonItem className='input-error' style={styles('--highlight-background:unset;--min-height:40px;margin-top:2.5px')}>
                                            <Input ion="popup" node={(handle) => <>
                                                <IonLabel hidden position='stacked'></IonLabel>
                                                <IonInput hidden></IonInput>
