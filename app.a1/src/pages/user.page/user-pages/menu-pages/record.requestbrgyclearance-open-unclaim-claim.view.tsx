...
export default class RequestBarangayClearacneAppHistory extends React.Component implements OnPagerFocus {
    ...
    //};
    onPagerFocus = (data: any) => (RequestBarangayClearacneAppHistory.activeTab && RequestBarangayClearacneAppHistory.activeTab.onPagerFocus(data));
...
export class ViewHolder extends React.Component {
    ...
    willMount = (didMount = true) => {
        ...
        const page = (this.page = { ParentTitle: '', PageTitle: 'Request Brgy. Clearance' });
    ...
    render() {
        const { page, tabs, prop: { didMount } } = this.state;
        return (<>
            <Layout full>
                <Layout>
                    <IonHeader>
                ...
                <Layout auto>
                    {!tabs ? null : <PowerApTabsView instance ={this} />}
                </Layout>
            </Layout>
        </>);
    }
...
class PowerApTabsView extends React.Component <{instance:ViewHolder}>{
    state: any = {};
    ...
    onSwapChange = () => {
        return timeout(() => {
            RequestBarangayClearacneAppHistory.activeTab = this.swapper.currentComponent.instance;
        });
                ...
                <div className="layout-horizontal">
                    ...
                    <div className="auto">
                        <div className="vertical" style={styles('position:relative;color:#737373;')}>
                            ...
                            <div style={styles('font-size: 14pt;font-weight:bold;margin-top: -2.5px')}>Control. No.: {item.ControlNo} {item.NextFilter}</div>
                            <div style={styles('font-size: 11pt;margin-top: -2.5px')}>Application Date: {item.ApplicationDate}</div>
                            <div style={styles('font-size: 11pt;margin-top: -2.5px')}>Type: {item.TypeofClearanceNM}</div>
                            <div style={styles('font-size: 11pt;margin-top: -2.5px')}>Purpose: {item.PurposeNM}</div>
                            <div className="horizontal" style={styles('justify-content: left;')}>
                                {/* <div className="btn-primary" style={styles('min-width: 20%;padding: 5px;font-size: 8px;height: 10%;')} onClick={onClick}>View Req. Doc</div>&nbsp; */}
                                {/* <div className="btn-update" style={styles('min-width: 20%;padding: 5px;font-size: 8px;height: 10%;')} onClick={onUpdateIssuesConcern}>Update Request Document</div>&nbsp; */}
                ...
                <div className="layout-horizontal">
                    ...
                    <div className="auto">
                        <div className="vertical" style={styles('position:relative;color:#737373;')}>
                            ...
                            <div className="horizontal" style={styles('justify-content: left;')}>
                                {/* <div className="btn-primary" style={styles('min-width: 20%;padding: 5px;font-size: 8px;height: 10%;')} onClick={onClick}>View Req. Doc.</div>&nbsp; */}
                                {/* <div className="btn-update" style={styles('min-width: 20%;padding: 5px;font-size: 8px;height: 10%;')} onClick={onUpdateIssuesConcern}>Update Request Brgy Clearance</div>&nbsp; */}
                                <IonButton size='small' onClick={onClick}>Details</IonButton>
                            </div>
                        </div>
                    </div>
                ...
                <div className="layout-horizontal">
                    ...
                    <div className="auto">
                        <div className="vertical" style={styles('position:relative;color:#737373;')}>
                            ...
                            {/* <div style={styles('font-size: 12px;margin-top: -2.5px')} hidden={(item.STAT == "Closed") ? false : true}>Corrective Action: {item.CorrectiveAction}</div> */}
                            {/* <div style={styles('font-size: 12px;margin-top: -2.5px')} hidden={(item.STAT == "Closed") ? false : true}>Corrective Date: {item.ActionDate}</div> */}
                            <div style={styles('font-size: 11pt;margin-top: -2.5px')} hidden={(!item.Release) ? true : false}>Status: {(item.Release) ? "Release" : "For Releasing"}</div>
                            <div style={styles('font-size: 11pt;margin-top: -2.5px')} hidden={(!item.Release) ? true : false}>Released Date.: {(item.Release) ? item.DateRelease : ""}</div>
                            <div style={styles('font-size: 11pt;margin-top: -2.5px')} hidden={(!item.Cancelled) ? true : false}>Status: {(item.Cancelled) ? "Cancelled" : "For Releasing"}</div>
                            <div style={styles('font-size: 11pt;margin-top: -2.5px')} hidden={(!item.Cancelled) ? true : false}>Date Cancelled: {item.Cancelled}</div>
                            <div className="horizontal" style={styles('justify-content: left;')}>
                                {/* <div className="btn-primary" style={styles('min-width: 20%;padding: 5px;font-size: 8px;height: 10%;')} onClick={onClick}>View Req. Doc.</div>&nbsp; */}
