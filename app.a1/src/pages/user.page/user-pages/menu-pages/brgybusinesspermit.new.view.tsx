...
export default class RequestBrgyBusinessPermitView extends React.Component {
...
export class ViewHolder extends React.Component {
    ...
    private performSubmit() {
        rest.post((this.input.isEdit) ? 'reqdoc/edit' :  'reqdoc/new', this.input).subscribe(async (res: any) => {
            if (res.Status == 'ok') {
                const item = Object.rcopy(res.Content, this.input);
                return Alert.showSuccessMessage(res.Message, () => this.pager.back({item, component:RequestBrgyBusinessPermitView, IsUpdate:!!this.input.isEdit,}));
            }
            ...
            <Layout full>
                <Layout>
                    <div className="row m-0 toolbar-panel">
                        ...
                        <div className="col-4 p-0 vertical toolbar-parent" onClick={this.hBackButton}>Brgy Clearance</div>
