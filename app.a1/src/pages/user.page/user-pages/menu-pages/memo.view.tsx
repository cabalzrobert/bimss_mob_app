...
export default class MemoAttachmentView extends React.Component {
    ...
    <Layout auto>
        <IonContent scrollY> 
            ...
            <div style={styles('position:relative;height:100%;width:100%;padding:10px')}>
                {!url?null:<>
                <iframe src={url+"?view=inline"} style={styles('width:100%;height:100%;border:none;')} typeof={"appliction/pdf"} allowFullScreen />
                </>}
            </div>
        </IonContent>
    </Layout>
