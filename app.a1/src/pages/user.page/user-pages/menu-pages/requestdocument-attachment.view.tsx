...
export default class RequestDocumentAttachmentView extends React.Component implements OnPagerFocus { //OnSwapFocus, 
...
export class ViewHolder extends React.Component {
    ...
    private performRequest(filter: any, callback: Function = mtCb) {
        ...
        this.subs.s1 = rest.post('reqdoc/loadreqdocattm', Object.rcopy(filter, this.filter)).subscribe(async (res: any) => {
            this.prop.IsFiltering = false;
            if (res.Status != 'error') {
            ...
            <Layout full>
                <Layout>
                    <div className="row m-0 toolbar-panel">
                        ...
                        <div className="col-7 p-0 toolbar-title vertical"><div><TextFit text="Attachment" /></div></div>
                    </div>
                </Layout>
                <Layout auto>
