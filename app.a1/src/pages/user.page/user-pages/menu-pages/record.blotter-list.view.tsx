...
import { addCircleOutline, addOutline, arrowBackOutline, imagesOutline, searchOutline } from 'ionicons/icons';
...
export default class BlotterAppHistory extends React.Component implements OnPagerFocus { //OnSwapFocus, 
                ...
                <div className="layout-horizontal">
                    ...
                    <div className="auto">
                        <div className="vertical" style={styles('position:relative;color:#737373;')}>
                            ...
                            <div style={styles('font-size: 12pt;font-weight: bold')}>Respondent: {item.RespondentName}</div>
                            <div style={styles('font-size: 12pt;margin-top: -2.5px')}>Issues: {item.Issue} {item.NextFilter}</div>
                            <div style={styles('font-size: 12pt;margin-top: -2.5px')}>Complaint Type: {item.ComplaintTypeName}</div>
                            <div style={styles('font-size: 12pt;margin-top: -2.5px')}>Place.: {item.IncidentPlaceName}</div>
                            <div style={styles('font-size: 12pt;margin-top: -2.5px')}>Incident Date.: {item.IncidentDate}</div>
                            <div style={styles('font-size: 12pt;margin-top: -2.5px')}>Time.: {moment(item.IncidentTime).format('hh:mm A')}</div>
                            <div className="horizontal" style={styles('justify-content: left;')}>
                                ...
                                <div className="btn-update" hidden={(item.Status_Type != 0) ? true : false} style={styles('min-width: 20%;padding: 5px;font-size: 8px;height: 10%;')} onClick={onUpdateIssuesConcern}>Update Complaint</div>&nbsp;
                                ...
                                <IonButton color='success' hidden={(item.Status_Type != 0) ? true : false} size='small' onClick={onUpdateIssuesConcern}>Update</IonButton>
                                <IonButton size='small' hidden={(item.TotalAttachment != 0) ? false : true} onClick={onViewAttachment}><IonIcon slot='icon-only' icon={imagesOutline}/></IonButton>
                            </div>
                        </div>
                    </div>
