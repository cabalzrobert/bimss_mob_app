...
import { IonButton, IonButtons, IonContent, IonHeader, IonIcon, IonImg, IonItem, IonLabel, IonList, IonListHeader, IonMenu as ionMenu, IonMenuButton, IonMenuToggle, IonPage, IonRefresher, IonRefresherContent, IonRippleEffect, IonSearchbar, IonSelect, IonSelectOption, IonSpinner, IonTitle, IonToolbar, NavContext } from '@ionic/react';
...
import RequestDocuemntAppHistory from './user-pages/menu-pages/record.requestdoc-open-unclaim-claim.view';
...
export default class UserPager extends React.Component implements OnDidBackdrop {
    ...
    componentWillMount = () => {
        ...
        const prop: any = (this.prop = { ImageData: './assets/img/icon_blank_profile.png' });
        if (!device.isBrowser) {
    ...
    componentDidMount = async () => {
        ...
        this.subs.u = jUserModify(async () => {
            ...
            this.input.MobileNumber = u.MOB_NO;
    ...
    render() {
        const { inner = {}, prop = {}, ready = false } = this.state;
        const { u = {} } = this.state;
        return (<>
            <IonPage id="main-content">
                <div className='horizontal'>
                    <Layout full style={styles('position:relative;background-color:transparent;max-width:100%;width:100%;height:100%', { width: inner.width, height: inner.height })}>
            ...
            {!ready ? null : <>
                <IonMenu content-id="main-content">
                    <IonHeader>
                        <IonToolbar color="primary">
                            <div className="col-12 p-0 row m-0 options">
                                <div className="col-3 p-0 row m-0 options">
                                    <div className="col-12" style={styles('text-align:right;height:auto;font-size:12px;font-weight:bold')}>
                                        <ImgPreloader placeholder="./assets/img/icon_blank_profile.png" style={styles('height:50px;border-radius:50%;overflow:hidden;display:flex;justify-content:center;')}
                                            src={(prop.ImageData || this.input.ImageUrl)}
                                        />
                                    </div>
                                </div>
                                <div className="col-9 p-0 row m-0 options">
                                    <div className="horizontal">
                                        <div className="col-12" style={styles('text-align:left;height:auto;font-size:12px;margin:auto;')}>
                                            <IonLabel>
                                                {this.input.Fullname}
                                            </IonLabel>
                                            <IonLabel>
                    ...
                    <IonContent>
                        <IonList style={styles('background: transparent;')}>
                            <IonMenuToggle>
                                <IonItem>
                                    {/* <IonImg slot="start" src="./assets/img/profile_edit_data.png" style={styles('width:30px;')}></IonImg> */}
                            ...
                            <IonMenuToggle>
                                <IonItem>
                                    ...
                                    <IonLabel onClick={this.hGameProfile}>
                                        Account Profile
                                    </IonLabel>
                                </IonItem>
                            </IonMenuToggle>
                            ...
                            {/* <IonMenuToggle>
                                ...
                                <IonList style={styles('margin-left:50px;')}>
                                    <IonItem>
                                        <IonIcon slot="start" icon={personCircleOutline}></IonIcon>
                                        <IonLabel onClick={this.hbrgySupport}>Sub Menu</IonLabel>
                                    </IonItem><IonItem>
                                        <IonIcon slot="start" icon={personCircleOutline}></IonIcon>
                                        <IonLabel  onClick={this.hbrgySupport}>Sub Menu1</IonLabel>
                                    </IonItem>
                                </IonList>
                            </IonMenuToggle> */}
                            <IonMenuToggle>
