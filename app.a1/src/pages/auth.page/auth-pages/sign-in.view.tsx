        ...
        return (<>
            <div className="layout full bootstrap-form" style={styles('padding:5px 10%')}>
                ...
                <div style={styles('height:75px')}>
                    <div style={styles('')}>
                        <img className="img-fit-logo" src='./assets/img/bimss.png'/>
                    </div>
                </div>
                <div className="form-container" style={styles('height:10%;;')}>
                    <form className={classNames('needs-validation', { 'form-invalid': !input.IsValid })} noValidate onSubmit={(ev) => ev.preventDefault()}>
                        <div className={classNames({ 'input-invalid': !!msg.Username })} style={styles('position:relative')}>
                            {/* <IonLabel className="" style={styles('color:#fff;padding-left:20px;font-weight:500;')}>Username</IonLabel> */}
                            <IonItem lines="none" className='input-error' style={styles('--min-height:50px;margin:5px 0px;border-radius:4px;')}>
                                <Input ion node={(handle) => <>
                                    <IonInput className="font-bold br-0" style={styles('--color:#fff;--padding-bottom:0px;--padding-top:0px')}
                                        type="text" placeholder="Username"
                                        value={input.Username} {...handle({ onChange: (ev) => this.hState(ev, 'Username') })} fill="outline"/>
                                </>} />

                            </IonItem>
                            <div className="invalid-tooltip">{msg.Username}</div>
                        </div>
                        <div className={classNames({ 'input-invalid': !!msg.Password })} style={styles('position:relative;margin-top:15px;')}>
                            {/* <IonLabel className="" style={styles('color:#fff;padding-left:20px;font-weight:500;')}>Password</IonLabel> */}
                            <IonItem lines="none" className='input-error' style={styles('--min-height:50px;margin:5px 0px;border-radius:4px;')}>
                                <Input ion node={(handle) => <>
                                    <IonInput className="font-bold br-0" style={styles('--color:#fff;--padding-bottom:0px;--padding-top:0px')}
                        ...
                        <div className="btn-sign-in" style={styles('margin-top:15px')}>
                            <IonButton className="singIn" onClick={this.hConfirm}>
                                Login
                            </IonButton>
                        </div>
                    </form>
                    <div className="btn-register" style={styles('margin-top:0px;text-align:center;font-size:inherit;')}>
                        <IonButton className="singUp" fill="clear" onClick={this.hSignup} >
                            Create Account
                        </IonButton>
                    </div>
                    ...
                    <div className="form-container" style={styles('height:10%;margin-bottom:5%;')}></div>
                ...
                {/* <div className="" style={styles('height:50%;')}></div> */}
                <div style={styles('height:0px')} >
                    ...
                    <div className="horizontal" style={styles('height:auto;font-size:90%;font-weight:bold;color:white;')}>
                        <div onClick={this.hForgotPassword}>FORGOT PASSWORD?</div>
                    </div>
