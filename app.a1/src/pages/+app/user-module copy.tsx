...
export const jUser = (()=>{
    var jUser:any = {}, isReady:boolean = false;
    return async(user:any=null, isMerge:boolean=false)=>{
        const ready = isReady; isReady = true;
        if(!ready) Object.rcopy(jUser, (await storage.user||jUser));
...
export const jCompany = (()=>{
    var jCompany:any = {}, isReady:boolean = false;
    return async(company:any=null, isMerge:boolean=false)=>{
        const ready = isReady; isReady = true;
        if(!ready) Object.rcopy(jCompany, (await storage.company||jCompany));
