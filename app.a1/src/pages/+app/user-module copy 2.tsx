...
export const jUser = (()=>{
    var jUser:any = {};
    (window as any).strg = storage;
    //const untilReady = whenReady(async(ready)=>(Object.rcopy(jUser, (await storage.user||jUser)),ready()),true);
...
export const jCompany = (()=>{
    var jCompany:any = {};
    //const untilReady = whenReady(async(ready)=>(Object.rcopy(jCompany, (await storage.company||jCompany)),ready()),true);
