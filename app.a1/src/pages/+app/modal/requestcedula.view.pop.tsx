...
export default class RequestCedulaPopUp extends React.Component<{ modal: Function, Subscriber: any }> implements OnDidBackdrop {
    state: any = {};
    filter: any = {};
    componentWillMount = () => {
        app.component(this);
                    ...
                    <div className="row m-0 bg-top option-container" style={styles('overflow:auto;')}>
                        ...
                        <div className="col-12 p-0 row m-0 options">
                            ...
                            <div className="col-7 p-0 row m-0 options">
                                <div className="col-12" style={styles('text-align:left;height:auto;font-size:12px')}>{subscriber.DoctypeNM}</div>
                            </div>
                        </div>
                        <div className="col-12 p-0 row m-0 options">
                            <div className="col-5 p-0 row m-0 options">
    ...
    static modal = async (subscriber: any = {}) => {
        ...
        var stack = await Stack.push(<>
            <Modal className="modal-adjustment width-350 no-bg mwf" ref={(ref) => modal = ref} content={<RequestCedulaPopUp modal={() => modal} Subscriber={subscriber} />} />
        </>);
