...
export default class RequestBrgyOtherDocumentPopUp extends React.Component<{ modal: Function, Subscriber: any }> implements OnDidBackdrop {
    state: any = {};
    filter: any = {};
    componentWillMount = () => {
        app.component(this);
    ...
    render() {
        ...
        return (<>
                ...
                <div className="sm-option-bg">
                    ...
                    <div className="row m-0 bg-top option-container" style={styles('overflow:auto;')}>
                        ...
                        */}
                        ...
                        <div className="col-12 p-0 row m-0 options">
                            <div className="col-5 p-0 row m-0 options">
                                <div className="col-12" style={styles('text-align:right;height:auto;font-size:12pt;font-weight:bold')}>Doc. Type</div>
                            </div>
                            <div className="col-7 p-0 row m-0 options">
                                <div className="col-12" style={styles('text-align:left;height:auto;font-size:12pt')}>{subscriber.TemplateName}</div>
                            </div>
                        </div>
                        <div className="col-12 p-0 row m-0 options">
                            <div className="col-5 p-0 row m-0 options">
                                <div className="col-12" style={styles('text-align:right;height:auto;font-size:12pt;font-weight:bold')}>Certificate</div>
                            </div>
                            <div className="col-7 p-0 row m-0 options">
                                <div className="col-12" style={styles('text-align:left;height:auto;font-size:12pt')}>{subscriber.TemplateTypeName}</div>
                            </div>
                        </div>
                        <div className="col-12 p-0 row m-0 options">
                            <div className="col-5 p-0 row m-0 options">
                                <div className="col-12" style={styles('text-align:right;height:auto;font-size:12pt;font-weight:bold')}>Request Date</div>
                            </div>
                            <div className="col-7 p-0 row m-0 options">
                        ...
                        <div className="col-12 p-0 row m-0 options">
                            ...
                            <div className="col-7 p-0 row m-0 options">
                                <div className="col-12" style={styles('text-align:left;height:auto;font-size:12pt')}>{subscriber.StatusRequestName}</div>
                            </div>
                        </div>
            ...
            <IonFooter>
                <div style={styles('height:auto;padding-top:1%;padding-bottom:1%;display:flex;justify-content:center;')}>
    ...
    static modal = async (subscriber: any = {}) => {
        ...
        var stack = await Stack.push(<>
            <Modal className="modal-adjustment width-350 no-bg mwf" ref={(ref) => modal = ref} content={<RequestBrgyOtherDocumentPopUp modal={() => modal} Subscriber={subscriber} />} />
        </>);
